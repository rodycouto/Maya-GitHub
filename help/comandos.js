...
exports.run = async (client, message, args) => {
  ...
  const linkgithub = 'https://github.com/rodycouto/NayaCommands/blob/main/README.md'
  ...
  if (!args[0]) {
    const newhelp = new Discord.MessageEmbed()
      ...
      .setFooter(`${prefix}gif | ${prefix}ideianaya | ${prefix}bug | ${prefix}donate | ${prefix}globalchat`)
  ...
  if (['afksystem', 'afk'].includes(args[0].toLowerCase())) {
    const embed = new Discord.MessageEmbed()
      .setColor('BLUE')
      .setTitle('📢 Naya - AFK Global System')
  ...
  if (['github', 'discordjs'].includes(args[0].toLowerCase())) {
    const embed = new Discord.MessageEmbed()
      .setColor('BLUE')
      .setTitle('👨‍💻 Naya GitHub - BETA COMMAND')
  ...
  if (['personagens'].includes(args[0].toLowerCase())) {
    const embed = new Discord.MessageEmbed()
      ...
      .setFooter(`${prefix}ideianaya | ${prefix}gif | ${prefix}bug`)
    return message.inlineReply(embed)
  }
