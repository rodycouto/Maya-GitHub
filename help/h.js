...
exports.run = async (client, message, args) => {
  ...
  if (['categoria', 'categorias'].includes(args[0].toLowerCase())) {
    const catego = new Discord.MessageEmbed()
      ...
      .addField('• Categorias Disponiveis (17)', '`' + prefix + 'h afksystem`\n' + '`' + prefix + 'h animes`\n' + '`' + prefix + 'h commands`\n' + '`' + prefix + 'h discordjs`\n' + '`' + prefix + 'h economy`\n' + '`' + prefix + 'h games`\n' + '`' + prefix + 'h interação`\n' + '`' + prefix + 'h levelsystem`\n' + '`' + prefix + 'h raphy`\n' + '`' + prefix + 'h moderation`\n' + '`' + prefix + 'h owner`\n' + '`' + prefix + 'h perfil`\n' + '`' + prefix + 'h personagens`\n' + '`' + prefix + 'h quiz`\n' + '`' + prefix + 'h random`\n' + '`' + prefix + 'h reações`\n' + `:tools: [Lista de Comandos](${linkgithub})`)
  ...
  if (['anime', 'animes'].includes(args[0].toLowerCase())) {
    const embed = new Discord.MessageEmbed()
      ...
      .addField('• Categoria Recomendada', '`' + prefix + 'h personagens`', true)
  ...
  if (['h', 'help', 'ajuda', 'comandos'].includes(args[0].toLowerCase())) {
    const embed = new Discord.MessageEmbed()
      ...
      .addField('• Comandos Online:', '`' + prefix + 'h`\n' + '`' + prefix + 'h`\n' + '`' + prefix + 'h`\n' + '`' + prefix + 'thanks`\n' + '`' + prefix + 'bjhelp/blackjackhelp`')
      .setFooter(`${prefix}ideiaraphy | ${prefix}bug`)
    return message.inlineReply(embed)
  }
  ...
  if (['role', 'cargo', 'roles', 'cargos'].includes(args[0].toLowerCase())) {
    const embed = new Discord.MessageEmbed()
      ...
      .addField('• Autorole System', '`' + prefix + 'h autorole`')
      .setFooter(`${prefix}ideiaraphy | ${prefix}bug`)
    return message.inlineReply(embed)
  } else {
    return message.inlineReply('Esta categoria não foi encontrada. use `' + prefix + 'h categoria` e veja as categorias disponiveis.')
  }
}