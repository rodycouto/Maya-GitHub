...
exports.run = async (client, message, args) => {
	...
	if (!args[0]) { return message.inlineReply('Convide alguém para usa familia! Pode até 3 pessoas. `' + prefix + 'family1 @user`') }
	...
	if (family === null && family2 === null) {
		...
		return message.inlineReply(`<a:attention:836101248183959562> Tem algo errado. Parece que algúm dos dois tem algo no Family 1.`)
	}
}